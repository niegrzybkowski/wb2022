...
plot <- ggplot(real_estate1 , aes(x=GarageType, y=SalePrice)) + 
  geom_boxplot()+
...
```{r, include=FALSE,warning=FALSE}
plot <- ggplot(real_estate1 , aes(x=Foundation, y=SalePrice)) + 
  geom_boxplot()+
  scale_y_continuous(labels = scales::comma)+
  theme_economist()
```
...
plot <- ggplot(real_estate1 , aes(x=YearBuilt, y=SalePrice)) + 
  geom_point()+
  scale_y_continuous(labels = scales::comma)+
  theme_economist()
```
...
```{r, include=FALSE,warning=FALSE}
plot <- ggplot(real_estate1 , aes(x=PoolArea, y=SalePrice)) + 
  geom_point()+
  scale_y_continuous(labels = scales::comma)+
  theme_economist()
```
