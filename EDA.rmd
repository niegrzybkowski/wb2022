...
Położenie budynków jak widać nie jest równomiernie rozłożone na tle dzielnic, najwięcej nieruchomości jest z Północnego Ames. Dzielnica ta znacząco wyróżnia się na tle pozostałych. Sa także dzielnice jak np. Blueste gdzie widać bardzo małą ilość obiektóW które były na sprzedaż. 
...
Można zauważayż, że pomimo iż rodzaji fundamtentóW jest 6 to większość obiektów ma tak na prawdę 1 z 3 rodzajów.
...
Na wykresie pomiędzy typem garażu, a ceną domu widać, że największą różnorodnośc cen mają nieruchomości z garażem wbudowanym w dom albo przyłączonym do niego. Nieruchomości z wbudowanym garażem mają także najwżyszą medianę cen, następnie za nimi domy z przyłączanym. Co interesujące to pomimo, że obiekty z wbudowanym garażem mają medianę cen najwyższą to najdroższe domy ze wszystkich mają garaże przyłączane do nich. 
...
Z wykresu położenia widać największą madianę cen mają nieruchomości wolnostojace. Warto zwrócić jednak uwagę na dużą ilość obserwacji odstających dla obiektów otoczonych z każdej z 4 stron. 
...
O ile górny kwantyl ceny dla nieruchomosći o kamiennych oraz betonowych fundamentach jest zblizony do siebie, to widać stosunkowo niską medianę cen dla domów z kamiennymi fundamentami. Także najdroższe domy to przedewszystkim takie o betonowych fundamentach.
